...
- [ ] **[NEXT] Sweep Stage 1 across the other 11 usable sessions** — each needs its ROI drawn once (GUI). Watch the 7 corrected / 5 uncorrected V split as a covariate. Cross-session held-out R² distribution = the Stage 1 deliverable.
