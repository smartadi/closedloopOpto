...
- [ ] Note for the write-up: AL_0048 has **no motion trace** (no `face_proc.mat`), so motion is unavailable as a state there; rel-δ is the common state across all 4 sessions.
