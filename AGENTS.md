...
Then read the matching sub-area AGENTS.md before starting work. Do not read more than one.

| Trigger words | Sub-area file to read |
|---|---|
| impulse, TF fit, dose-response, AL_0041 | `impulse-analysis/AGENTS.md` |
| controller, plottingScript, CL vs OL, MSE, sessions | `controller-analysis/AGENTS.md` |
| manuscript, LaTeX, results_edit, paper, Overleaf | `paper-writing/AGENTS.md` |
| bilateral, AL_0048, dual opsin, excitatory, inhibitory, galvo, variable ref, tuning, grid sweep, gradient descent, photostim site-grid, opto_brainGrid | `bilateral/AGENTS.md` |
| controller grid, gain grid, gain sweep, Kp Ki sweep, cost surface, J(Kp,Ki), auto-tune, auto-tuning, tuning methodology | `controller-tuning/AGENTS.md` |
| explore, staging, inspect, vibe, server root, list files | `explore/AGENTS.md` |
...
brain_paper/
  ...
  impulse-analysis/
    AGENTS.md            ← impulse context (~35 lines, load for impulse sessions)
  controller-analysis/
    AGENTS.md            ← controller context (~35 lines, load for CL/OL sessions)
  paper-writing/
    AGENTS.md            ← manuscript context (~35 lines, load for writing sessions)
