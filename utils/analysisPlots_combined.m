...
plot(ax_E, Tin, 3*nc_inp_mean, 'Color', colInpOL, 'LineWidth', 1.5, 'HandleVisibility','off');
...
plot(ax_F, Tin, 3*wc_inp_mean, 'Color', colInpCL, 'LineWidth', 1.5, 'HandleVisibility','off');
