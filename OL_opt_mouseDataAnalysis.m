...
if isfield(d, 'input_params') && size(d.input_params, 2) >= 13
    ...
    d.stim_groups_by_pixel = splitStimStartsByPixelAndMode(d.stimStarts, d.input_params, [13 14], 12, 1);
...
pixelTuningCurveViewerSVD(U, V(:,1:end-1), t, d.stimStarts, ones(size(d.stimStarts)), [-1 6])
