...
% px = [350,300, 200,300]+offsetx;
% py = [225,335, 325,325]+offsety;



% px = [200,300,150]+offsetx;
% py = [150,150,225]+offsety;
% px = [200,300,150,200,300,350]+offsetx;
% py = [150,150,225,225,225,225]+offsety;
...
% plot(frame2(1,:),frame2(2,:)','og','LineWidth',2)
...
dFk = data.dFk;
%%
data_pix = getpixel_dFoF_pix(d,mode,d.params.pixels);
% 
dFk_pix = data_pix.dFk;
